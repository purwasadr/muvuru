...
export default function DetailShow({movieDetail, showCredit}: InferGetServerSidePropsType<
...
export const getServerSideProps: GetServerSideProps<{
  ...
  const [movieDetail, movieCredit] = await Promise.allSettled([ getMovieDetail(id), getMovieCredit(id)]);
