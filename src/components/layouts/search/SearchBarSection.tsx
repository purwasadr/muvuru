...
const SearchBarSection = ({ selectValue, className }: Props) => {
  ...
  return (
    <section className={cn("",className)}>
      <form onSubmit={(e) => handleSubmitSearch(e)} className='flex w-full items-center py-1 max-w-xl rounded-full bg-slate-700 mx-auto'>
        <SelectMediaType
          defaultValue={'movie'}
          value={selectValue}
        ...
        <input
          className="block w-full rounded-md bg-transparent shadow-sm border-none focus:border-none focus:ring-0 sm:text-sm"
          type="text"
          value={searchQuery}
